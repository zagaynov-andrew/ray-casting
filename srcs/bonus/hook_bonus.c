...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/03/31 16:08:47 by ngamora           #+#    #+#             */
/*   Updated: 2021/03/31 17:31:23 by ngamora          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		key_pressed(int key_code, t_game *game)
{
	...
	if (key_code == KEY_UP)
		game->player.rotation |= CAMERA_UP;
	else if (key_code == KEY_DOWN)
		game->player.rotation |= CAMERA_DOWN;
	return (0);
}
...
int		key_released(int key_code, t_game *game)
{
	if (key_code == KEY_W)
		...
		game->player.rotation &= (0b11111111 - CAMERA_UP);
	else if (key_code == KEY_DOWN)
		game->player.rotation &= (0b11111111 - CAMERA_DOWN);
	if (key_code == KEY_ESC)
		exit_game(game);
	return (0);
}
